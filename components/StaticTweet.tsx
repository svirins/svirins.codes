  ...
  return (
    <div className='tweet rounded-lg border !border-gray-700 px-6 py-4 my-4 bg-white !bg-gray-800 max-w-2xl mx-auto'>
      ...
      <div className='flex text-sm mt-2'>
        <a
          className='flex items-center mr-4 !text-gray-400 hover:!text-code-blue selection:transition !hover:underline'
          href={replyUrl}
          target='_blank'
          rel='noopener noreferrer'
        >
          ...
          <span>
            {new Number(tweet.public_metrics.reply_count).toLocaleString('en', {
              notation: 'compact'
            })}
          </span>
        </a>
        ...
        >
          ...
          <span>
            {new Number(tweet.public_metrics.retweet_count).toLocaleString(
              'en',
              {
                notation: 'compact'
              }
        ...
        >
          ...
          <span>
            {new Number(tweet.public_metrics.like_count).toLocaleString('en', {
              notation: 'compact'
            })}
          </span>
        </a>
